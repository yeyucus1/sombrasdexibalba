...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset("/template_pgadmin/plugins/fontawesome-free/css/all.min.css")}}">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Tempusdominus Bootstrap 4 -->
    <link rel="stylesheet" href="{{asset("template_pgadmin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css")}}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset("template_pgadmin/plugins/icheck-bootstrap/icheck-bootstrap.min.css")}}">
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{asset("template_pgadmin/plugins/jqvmap/jqvmap.min.css")}}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset("template_pgadmin/dist/css/adminlte.min.css")}}">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="{{asset("template_pgadmin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css")}}">
    <!-- Daterange picker -->
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="{{asset("template_pgadmin/dist/img/user1-128x128.jpg")}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="{{asset("template_pgadmin/dist/img/user8-128x128.jpg")}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    John Pierce
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="{{asset("template_pgadmin/dist/img/user3-128x128.jpg")}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{asset("template_pgadmin/dist/img/user2-160x160.jpg")}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                        ...
                        <div class="card direct-chat direct-chat-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="template_pgadmin/dist/img/user1-128x128.jpg" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="template_pgadmin/dist/img/user3-128x128.jpg" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                            ...
                            <small class="contacts-list-date float-right">2/28/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                <img class="contacts-list-img" src="{{asset("template_pgadmin/dist/img/user7-128x128.jpg")}}" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/23/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{asset("template_pgadmin/dist/img/user3-128x128.jpg")}}" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{asset("template_pgadmin/dist/img/user5-128x128.jpg")}}" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/10/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{asset("template_pgadmin/dist/img/user6-128x128.jpg")}}" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{"template_pgadmin/dist/img/user8-128x128.jpg"}}" alt="User Avatar">
